# Part 5 of Project 2 requires an output of a PNG plot that shows the total PM2.5 emission from
...
#   so the next step is to subect only the Baltimore City related part of the NEI
...
# Test below was to find number of matches betwen SCC codes from the SCC_mv_IDs vector
#   and the Baltimore City SCC IDs in NEI_bal_city_IDs, 492 found
# cnt <- 0
...
# Running length(unique(mv_rows[,2])) also gives 492 unique values in
...
# Below is the test plot in RStudio
